...
if score < 1 and mode == "Sandbox":
    ...
    exit()
tts("Wow!")
tts("You have completed 3 phone calls and have got " + str(score) + " points!")
...
input("Type Y to accept, or N to decline.")
tts("Hi!")
tts("We want to send files between our Fire Tablets.")
...
tts("I heard about GitHub Actions, but I don't know how to use that.")
tts("Do you know how to use that?")
command = input("You: ")